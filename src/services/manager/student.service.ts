import type {
  StudentTabFilter,
  StudentListResponse,
} from "@/types/manager/student.types";
import { MOCK_STUDENTS } from "@/constants/manager/student.constants";
...
export async function fetchStudents(
  ...
  const items = filtered.slice((page - 1) * STUDENT_PAGE_SIZE, page * STUDENT_PAGE_SIZE);
