    ...
    <div className="w-[300px] min-w-[300px] border-r border-slate-200 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        {filteredRooms.length === 0 ? (
          <p className="text-[11.5px] text-slate-400 text-center py-8">대화가 없습니다.</p>
        ) : (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-[10px] text-slate-400 shrink-0 ml-1">{room.lastMessageAt}</p>
                </div>
                <p className="text-[11px] text-slate-400 truncate mt-0.5">{room.lastMessage}</p>
              </div>
            </button>
          ))
        )}
