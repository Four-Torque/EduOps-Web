...
} from "@/constants/manager/schedule.constants";
import { useScheduleStore } from "@/store/manager/schedule.store";

export function ScheduleFilterBar() {
  const { room, instructor, subject, setRoom, setInstructor, setSubject, clearFilters } =
    useScheduleStore();

  return (
    <div className="flex items-center justify-between border border-slate-200 rounded-lg px-4 py-2.5 mb-4 bg-white">
