...
import { useStudentEditStore } from "@/store/manager/student-edit.store";
import { useRegisterStudent } from "@/hooks/manager/student-register.hooks";
import {
  MOCK_CLASS_OPTIONS,
  STUDENT_STATUS_OPTIONS,
} from "@/constants/manager/student-register.constants";
...
export function StudentRegisterModal() {
  const { isModalOpen, form, errors, closeModal, setField, setErrors } = useStudentRegisterStore();
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div ref={modalRef} className="bg-white rounded-lg shadow-xl w-[420px] overflow-hidden">
        {/* 헤더 */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200">
          <h2 className="text-[14px] font-semibold text-slate-800">학생 등록</h2>
