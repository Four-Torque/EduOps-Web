...
import { useBillingTransactions } from "@/hooks/manager/billing.hooks";
import type { BillingTransaction, BillingTabFilter } from "@/types/manager/billing.types";
    ...
    render: (item: BillingTransaction) => (
      <div className="flex items-center gap-2.5">
        ...
        <div className="text-left">
          <p className="text-[12.5px] font-medium text-slate-900">{item.studentName}</p>
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-[15px] font-semibold text-slate-900">최근 거래내역</h2>
        <BillingFilterTabs
          active={tab}
