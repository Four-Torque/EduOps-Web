import { MOCK_BILLING_STATS } from "@/constants/manager/billing.constants";
...
export function BillingStatsPanel() {
  ...
  return (
    <div className="w-[280px] min-w-[280px] flex flex-col gap-4">
      ...
      {/* 수업료 현황 */}
      <div className="border border-slate-200 rounded p-5 bg-white">
        <p className="text-[13px] font-semibold text-slate-900 mb-0.5">수업료 현황</p>
        ...
        <div className="flex items-center gap-3 mt-2">
          <div className="flex items-center gap-1">
            ...
            <span className="text-[10.5px] text-slate-500">완료 ({stats.paidCount}명)</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-2 h-2 rounded-full bg-red-300" />
            <span className="text-[10.5px] text-slate-500">미완료 ({stats.unpaidCount}명)</span>
          </div>
        </div>
      </div>
    </div>
