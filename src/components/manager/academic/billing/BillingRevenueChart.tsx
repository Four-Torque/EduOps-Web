import { MOCK_MONTHLY_REVENUE } from "@/constants/manager/billing.constants";
import type { MonthlyRevenue } from "@/types/manager/billing.types";
  ...
  return (
    <div className="flex-1 border border-slate-200 rounded p-5 bg-white">
      ...
      <div className="flex gap-3">
        {data.map((d: MonthlyRevenue) => (
          <div key={d.month} className="flex-1 text-center text-[11px] text-slate-400">
            {d.month}
          </div>
        ))}
      </div>
