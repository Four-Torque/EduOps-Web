// @/components/manager/academic/course/CourseGrid.tsx
"use client";

import { CourseCard } from "./CourseCard";
import { CourseSearchBar } from "./CoursesSearchBar";
import { useCourses } from "@/hooks/manager/course.hooks";
import type { Course } from "@/types/manager/course.types";
  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <p className="text-center text-[12px] text-slate-400 py-8">해당 조건의 강좌가 없습니다.</p>
      ) : (
