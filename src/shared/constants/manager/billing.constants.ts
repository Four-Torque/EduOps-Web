...
export const MOCK_BILLING_TRANSACTIONS: BillingTransaction[] = [
  { id: "INV-2024-0891", studentName: "Elena Johnson",  studentCode: "ID: 994021", avatarInitial: "EJ", description: "Fall Tuition - Level 3",       amount: 1250000, date: "Oct 24, 2024", status: "완료"  },
  { id: "INV-2024-0892", studentName: "Marcus Chen",    studentCode: "ID: 994033", avatarInitial: "MC", description: "Material Fee - Art Supplies",   amount: 65000,   date: "Oct 23, 2024", status: "미완료" },
  { id: "INV-2024-0885", studentName: "Sarah Rahman",   studentCode: "ID: 993105", avatarInitial: "SR", description: "Fall Tuition - Level 2",       amount: 1100000, date: "Oct 20, 2024", status: "대기"  },
  { id: "INV-2024-0870", studentName: "David Torres",   studentCode: "ID: 992044", avatarInitial: "DT", description: "Library Fine",                  amount: 15000,   date: "Oct 15, 2024", status: "연체"  },
  { id: "INV-2024-0870", studentName: "David Torres",   studentCode: "ID: 992044", avatarInitial: "DT", description: "Library Fine",                  amount: 15000,   date: "Oct 15, 2024", status: "연체"  },
  { id: "INV-2024-0870", studentName: "David Torres",   studentCode: "ID: 992044", avatarInitial: "DT", description: "Library Fine",                  amount: 15000,   date: "Oct 15, 2024", status: "연체"  },
];
